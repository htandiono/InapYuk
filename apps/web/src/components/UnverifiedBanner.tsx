...
export async function UnverifiedBanner() {
  ...
  let isVerified = true;
  try {
    isVerified = (decodeJwt(token) as unknown as JwtPayload).isVerified;
  } catch {}
  if (isVerified) return null;
  return (
    <div className="bg-amber-100 p-3 text-center text-sm font-medium text-amber-800">
      Akun kamu belum diverifikasi. Cek email untuk link verifikasi agar bisa menggunakan semua
      fitur.{' '}
