...
function ActionSkeleton() {
  return (
    <div className="flex justify-end gap-2">
      <Skeleton className="h-9 w-28 rounded-lg" /><Skeleton className="h-9 w-20 rounded-lg" /><Skeleton className="h-9 w-24 rounded-lg" />
    </div>
  );
}
...
export function TableLoadingRow() {
  return (
    <tr className="hover:bg-transparent border-b border-border/40">
      <td className="h-24"><PropSkeleton /></td>
      ...
      <td className="h-24 text-right"><ActionSkeleton /></td>
    </tr>
  );
}
...
export function TableEmptyRow() {
  return (
    <tr className="hover:bg-transparent">
      <td colSpan={4} className="h-100 text-center"><EmptyRowContent /></td>
    </tr>
  );
}
