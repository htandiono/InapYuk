...
function ChangePasswordFormContent({
  ...
  isSubmitting: { value: boolean; setIsSubmitting: React.Dispatch<React.SetStateAction<boolean>> };
}) {
  const hint =
  ...
  return (
    <CardContent>
      <Form {...form}>
        <form
          onSubmit={form.handleSubmit((v: FormData) =>
            submitPasswordChange(v, isSubmitting.setIsSubmitting, () => form.reset()),
          )}
        ...
        >
          ...
          <PasswordField
            ...
            disabled={isSubmitting.value}
          />
          <Button type="submit" disabled={isSubmitting.value} className="w-full">
            {isSubmitting.value ? 'Memproses...' : 'Ubah Password'}
          </Button>
        </form>
      </Form>
    </CardContent>
  ...
  return (
    <Card>
      ...
      <ChangePasswordFormContent
        form={form}
        isSubmitting={{ value: isSubmitting, setIsSubmitting }}
      />
    </Card>
  );
}
