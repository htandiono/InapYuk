...
function RegisterTenantFormFields({
  register,
  errors,
  isSubmitting,
}: {
    ...
    <>
      ...
      <div className="space-y-2">
        ...
        {errors.companyAddress && (
          <p className="text-sm text-destructive">{errors.companyAddress.message as string}</p>
        )}
      </div>
    </>
  );
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <RegisterTenantFormFields register={register} errors={err} isSubmitting={isSub} />
            <RegisterTenantFormActions isSubmitting={isSub} />
          </form>
        </CardContent>
      </Card>
    </div>
