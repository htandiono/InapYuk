    ...
    <div className="flex min-h-full flex-col">
      ...
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col px-5 pt-8 pb-16 sm:px-8">
        ...
        <div className="space-y-6 text-foreground leading-relaxed">
          ...
          <p>
            Di <strong>InapYuk</strong>, privasi dan keamanan data Anda adalah prioritas utama kami. Dokumen Kebijakan Privasi ini menjelaskan bagaimana kami mengumpulkan, menggunakan, menyimpan, dan melindungi informasi pribadi Anda saat Anda menggunakan platform kami.
          </p>
          ...
          <section className="mt-8">
            ...
            <p className="text-muted-foreground">
              Kami menggunakan enkripsi berstandar industri (seperti bcrypt untuk kata sandi) dan koneksi aman (HTTPS) untuk melindungi data Anda. Kata sandi Anda di-hash dan tidak pernah disimpan dalam bentuk teks biasa.
            </p>
          </section>

          <section className="mt-8 border-t border-border/40 pt-6">
            <p className="text-sm text-muted-foreground">
              Dengan menggunakan layanan InapYuk, Anda menyetujui pengumpulan dan penggunaan informasi sesuai dengan kebijakan ini. Jika Anda memiliki pertanyaan lebih lanjut, hubungi kami di <a href="mailto:privacy@inapyuk.space" className="text-primary hover:underline">privacy@inapyuk.space</a>.
            </p>
          </section>
        </div>
      </main>
